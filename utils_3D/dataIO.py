...
try:
    ...
    pass
    print 'trimesh, stl are not loaded, some functionality may not work: dataIO.py'
...
def getAll(path, obj='airplane',train_or_test='train', cube_len=64, obj_ratio=1.0):
    objPath = os.path.join( path, obj, '30', train_or_test )+'/'
